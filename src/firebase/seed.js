...
const peliculasEjemplo = [
  ...
  },
  {
    ...
    poster: 'https://www.race.es/revista-autoclub/wp-content/uploads/sites/4/2022/05/el-padrino-el-clasico-de-los-clasicos-759x500.jpg',
    puntuacionTotal: 0,
    numVotos: 0,
  },
  {
...
export async function seedPeliculas() {
  for (const pelicula of peliculasEjemplo) {
    ...
    await setDoc(doc(collection(db, 'peliculas'), id), data)
  }
}
